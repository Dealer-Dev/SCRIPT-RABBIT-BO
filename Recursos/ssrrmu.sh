#!/bin/bash
echo ""
wget -q -O /tmp/ssr https://raw.githubusercontent.com/Dealer-Dev/SCRIPT-RABBIT-BO/main/msg-bar/msg 
cat /tmp/ssr > /tmp/ssrrmu.sh
wget -q -O /tmp/ssr https://raw.githubusercontent.com/Dealer-Dev/SCRIPT-RABBIT-BO/main/Recursos/menu_inst/C-SSR.sh
cat /tmp/ssr >> /tmp/ssrrmu.sh
