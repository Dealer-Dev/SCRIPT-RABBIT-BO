...
trojan() 
{
wget -q https://raw.githubusercontent.com/Dealer-Dev/SCRIPT-RABBIT-BO/main/Recursos/trojango.sh; chmod +x trojango.sh; ./trojango.sh
rm -f trojango.sh
}
...
enon(){
echo "source <(curl -sSL https://raw.githubusercontent.com/Dealer-Dev/SCRIPT-RABBIT-BO/main/Recursos/menu/mod-v2ray.sh)" > /bin/troj.sh
chmod +x /bin/troj.sh
		clear
		echo -e $barra
...
autoDel(){
source <(curl -sSL https://raw.githubusercontent.com/Dealer-Dev/SCRIPT-RABBIT-BO/main/Recursos/trojango-sh/trojan-sh/autodel-trojan.sh)
	}
